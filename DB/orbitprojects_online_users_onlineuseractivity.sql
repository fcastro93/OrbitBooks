...
CREATE TABLE `online_users_onlineuseractivity` (
  ...
  CONSTRAINT `online_users_onlineuseractivity_user_id_6def50a3_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
...
INSERT INTO `online_users_onlineuseractivity` VALUES (1,'2018-09-07 16:22:19.231000',1),(2,'2018-09-07 16:39:59.226000',4);
